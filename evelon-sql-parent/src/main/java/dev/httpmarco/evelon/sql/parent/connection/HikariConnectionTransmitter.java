...
public final class HikariConnectionTransmitter {
    ...
    public @NotNull UpdateResponse executeUpdate(final String query, BuildProcess process, Object... arguments) {
    ...
    public <T> @NotNull QueryResponse<T> executeQuery(final String query, BuilderTransformer<ResultSet, T> function, Object defaultValue, BuildProcess process, Object... arguments) {
    ...
    private <R extends ResponseResult<?>> @NotNull R transferPreparedStatement(HikariConnectionFunction<PreparedStatement, R> function, String query, BuildProcess process, @NotNull Object... arguments) {
